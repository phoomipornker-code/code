...
แท็ก: `cv58-boost-v14-forward-v78` (= โค้ดชาร์จได้จาก v63)

> Branch: `cursor/fix-forward-keep-boost-1b21`  
> https://github.com/phoomipornker-code/code/tree/cursor/fix-forward-keep-boost-1b21/firmware
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v78` และจอแสดง `BOOT OK`  
   **v78 = โค้ดควบคุมเดียวกับ v63 ที่ชาร์จได้** (คืนจากแท็ก `cv58-boost-v14-forward-v63`)  
   ...
   ใกล้เต็ม: heal Vf/If ที่ค้าง; FULL ใช้ max(V,Vf)+min(I) confirm 15s / fast 5s  
   SPIKE-PRECUT ไม่ latch OVP จากจัมพ์ดิบเดียวตอน filt ยังต่ำ (กัน false OVP ตอนเข้า CV)
