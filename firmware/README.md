...
แท็ก: `cv58-boost-v14-forward-v79` (= โค้ดชาร์จได้จาก v63; `[STAT]` ทุก 1 นาที)
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v79` และจอแสดง `BOOT OK`  
   **ควบคุม = v63 ที่ชาร์จได้** · `[STAT]` ทุก **1 นาที** (v79)  
