...
%  but cascade: voltage PI -> Iref, current PI -> dDuty -> Memory+Add.
%  No MATLAB Function.
%
%    cd sim
%    build_forward_cccv_blocks
...
add_line(model, 'V_OUT/1', 'RelayCV/1');
...
% ---- Memory + Add accumulates duty (NOT Ts/(z-1)) ----
...
add_block('simulink/Discrete/Memory', [model '/MemDuty'], ...
    'InheritSampleTime', 'off', 'SampleTime', '0.02', ...
