...
แท็ก: `cv58-boost-v14-forward-v24`

## นโยบายเวอร์ชันนี้

- **Boost (PV):** ยึดตามโค้ดที่ทดสอบจริง `cv58-stability-v14` — PWM **50 kHz**, CC **6 A**, SoftStart→CC_MPPT→CV→DONE
- **Forward (AC):** SoftStart→CC→CV→DONE แบบเดียวกับ Boost (PI/CV/slew ชุดเดียวกัน) @ **67 kHz / 5 A**, อินพุต **AC 110 V** บริดจ์ DC — ไม่มี MPPT
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] Firmware: cv58-boost-v14-forward-v24`
...
Changelog: [`CHANGELOG_v24.md`](CHANGELOG_v24.md) · [`CHANGELOG_v23.md`](CHANGELOG_v23.md) · [`CHANGELOG_v22.md`](CHANGELOG_v22.md) · [`CHANGELOG_v21.md`](CHANGELOG_v21.md) · [`CHANGELOG_v20.md`](CHANGELOG_v20.md) · [`CHANGELOG_v19.md`](CHANGELOG_v19.md) · [`CHANGELOG_v18.md`](CHANGELOG_v18.md) · [`CHANGELOG_v17.md`](CHANGELOG_v17.md)
