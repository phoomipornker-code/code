...
แท็ก: `cv58-boost-v14-forward-v76`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v76`  
   ตารางทุก ~1 s (Duty = **raw 0–460**) + `[START]`/`[STOP]`/`[OVP]`/`[OC]`/`[MODE]` — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)
