...
แท็ก: `cv58-boost-v14-forward-v67`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v67` และจอแสดง `BOOT OK`  
   บรรทัด `CSV …` ตอนชาร์จสำหรับ Excel — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
   `[STAT] STANDBY` ขึ้นเฉพาะตอนสลับโหมด (ไม่สแปมตอนรอ)
