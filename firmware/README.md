...
แท็ก: `cv58-boost-v14-forward-v66`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v66` และจอแสดง `BOOT OK`  
   บรรทัด `CSV t_s Vout Iplot Dplot Vinplot` (เลื่อนแกนให้เส้นห่างกัน) — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
   ตอนทำงานจะมี `[STAT]` เป็นระยะ; ตอนชาร์จจอดับจน FULL; OVP ยังขึ้นจอได้
