...
แท็ก: `cv58-boost-v14-forward-v74`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v74`  
   ตารางทุก ~1 s + `[MODE]` เมื่อสลับโหมด — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)
