...
> **โฟลเดอร์ sketch แยก (แนะนำ):** [`../cv58-boost-v14-forward-v83/`](../cv58-boost-v14-forward-v83/) — Boost CV damp (v83) · BMS จาก v14 · Forward คง v75/v81

> Branch: `cursor/fix-forward-keep-boost-1b21`  
> ZIP: https://github.com/phoomipornker-code/code/archive/refs/heads/cursor/fix-forward-keep-boost-1b21.zip  
> ขั้นตอน: [`FLASH_v83.txt`](FLASH_v83.txt)
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v83`  
   ตารางทุก **20 วินาที** + `[START]`/`[STOP]`/`[OVP]`/`[OC]`/`[MODE]` เมื่อเกิดเหตุการณ์ — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
   Boost ตาม **v14-cv-stable** · Forward ตาม **v75**
