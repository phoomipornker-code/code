...
static const float CV_VOLTAGE_V = 56.6f;
static const float CV_ENTER_V = 56.2f;
static const float CV_EXIT_V = 55.8f;
...
// Protection
// --------------------------
static const float HARD_OVP_V = 58.5f;
static const float HARD_OVP_RELEASE_V = 56.2f;
