...
แท็ก: `cv58-boost-v14-forward-v59`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v59` และจอแสดง `BOOT OK`  
   ตอนทำงานจะมี `[STAT]` บรรทัดเดียวเป็นระยะ (ไม่มี RAW dump)  
   ตอนชาร์จจอแสดงรูปแบต `[████------]*SOC%` (ไม่ใช้ custom char — กันจอเพี้ยนจาก EMI)
