...
แท็ก: `cv58-boost-v14-forward-v53`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] Firmware: cv58-boost-v14-forward-v53` และจอแสดง `BOOT OK`
