...
แท็ก: `cv58-boost-v14-forward-v71`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v71`  
   ตาราง `Tim Iin Vin Iout Vout Duty` (ไม่โชว์ `[CAL]`) — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
   `[STAT]` เฉพาะสลับโหมด / START
