...
แท็ก: `cv58-boost-v14-forward-v77`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v77`  
   ตารางทุก ~1 s จาก **TaskSerialLog** (ไม่รบกวน ADC/PWM) + `[START]`/`[STOP]`/`[OVP]`/`[OC]`/`[MODE]`  
   Duty = **raw 0–460** — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)
