...
แท็ก: `cv58-boost-v14-forward-v81`  

> **โฟลเดอร์ sketch แยก (แนะนำ):** [`../cv58-boost-v14-forward-v81/`](../cv58-boost-v14-forward-v81/) — เปิด `.ino` ในโฟลเดอร์นั้นได้เลย (= ควบคุม v75 · ตาราง Serial ทุก 20 วินาที)
...
> ขั้นตอน: [`FLASH_v81.txt`](FLASH_v81.txt)
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v81`  
   ตารางทุก **20 วินาที** + `[START]`/`[STOP]`/`[OVP]`/`[OC]`/`[MODE]` เมื่อเกิดเหตุการณ์ — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
   ควบคุมชาร์จเหมือน **v75**
