...
แท็ก: `cv58-boost-v14-forward-v75`
...
> ขั้นตอน: [`FLASH_v75.txt`](FLASH_v75.txt)
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v75`  
   ตารางทุก ~1 s + `[START]`/`[STOP]`/`[OVP]`/`[OC]`/`[MODE]` เมื่อเกิดเหตุการณ์ — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)
