...
แท็ก: `cv58-boost-v14-forward-v80` (= ควบคุม v75 · ตาราง Serial ทุก 1 นาที)
...
> ขั้นตอน: [`FLASH_v80.txt`](FLASH_v80.txt)
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v80`  
   ตารางทุก **1 นาที** + `[START]`/`[STOP]`/`[OVP]`/`[OC]`/`[MODE]` เมื่อเกิดเหตุการณ์ — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
