...
แท็ก: `cv58-boost-v14-forward-v65`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v65` และจอแสดง `BOOT OK`  
   บรรทัด `CSV t_s Vin Vout Iout Duty` ทุก ~1 s สำหรับ Excel — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
