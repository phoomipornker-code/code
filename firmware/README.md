...
แท็ก: `cv58-boost-v14-forward-v70`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v70`  
   ตาราง `Tim Iin Vin Iout Vout Duty` ตามตัวอย่าง — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
