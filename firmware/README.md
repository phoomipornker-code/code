...
แท็ก: `cv58-boost-v14-forward-v68`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v68` และจอแสดง `BOOT OK`  
   CSV: `time Vin Vout Iout Duty` (ค่าจริง) — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
