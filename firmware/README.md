...
แท็ก: `cv58-boost-v14-forward-v64`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v64` และจอแสดง `BOOT OK`  
   บรรทัด `CSV …` ทุก ~1 s สำหรับพล็อต Excel — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
