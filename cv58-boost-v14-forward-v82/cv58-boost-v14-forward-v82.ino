...
#include <math.h>
#include <stdarg.h>
const char* FW_VERSION_TAG = "cv58-boost-v14-forward-v82";
// v82: restore Boost BMS/OVP/safety exactly from cv58-stability-v14-cv-stable.
// Forward keeps v75/v81 step-hysteresis control + Serial table every 20 s.
