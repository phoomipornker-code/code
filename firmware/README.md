...
แท็ก: `cv58-boost-v14-forward-v69`
...
5. Upload ลง ESP32
6. เปิด Serial Monitor **115200 baud** — ควรเห็น `[BOOT] cv58-boost-v14-forward-v69` และจอแสดง `BOOT OK`  
   CSV: `Tim Iin Vin Iout Vout Duty` — ดู [`EXCEL_PLOT.md`](EXCEL_PLOT.md)  
   `[STAT]` มีเวลา; STANDBY ขึ้นเฉพาะตอนสลับโหมด
